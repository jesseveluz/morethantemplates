...
if (isset($_GET['t']) && isset($_GET['pg']) && !isset($_GET['p'])){
		...
		if (isset($_COOKIE[md5("adminname".__SECRET_WORD__)]) || $moderatorID==$memberid){
			...
			$query = "select f_postID from ".$dbprefix_."forumposts where f_postforumID=".$_GET['t']." and f_postreplyto='0' and f_postreplyto='0' and (f_poststatus='published' or f_postauthorID='".$memberid."') ";
		}
